...
type WithdrawMethod = 'mobile-money' | 'moni-agent' | null;
    ...
    <div className="absolute inset-0 bg-black/50 flex items-end z-50 rounded-[40px]">
      <div className="w-full bg-moni-card rounded-t-3xl p-6 max-h-[90%] overflow-y-auto">
        ...
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl font-bold text-moni-white font-montserrat">Effectuer un retrait</h2>
        ...
        {step === 'method' && !method ? (
            ...
            <div className="space-y-4">
              ...
              <div className="bg-moni-bg rounded-2xl p-3 border border-white/10">
                <p className="text-moni-gray text-xs">
                  ...
                  Les frais de retrait seront déduits du montant
                </p>
              </div>
              ...
              <div className="bg-moni-bg rounded-2xl p-4 border border-white/10">
                ...
                <div className="space-y-2">
                  <button className="w-full p-3 bg-white/5 rounded-xl text-moni-white hover:bg-white/10 transition-all flex items-center gap-3">
                    <i className="fas fa-map-marker-alt text-moni-accent"></i>
                    <span className="text-sm">Agents près de moi</span>
                  </button>
                  <button className="w-full p-3 bg-white/5 rounded-xl text-moni-white hover:bg-white/10 transition-all flex items-center gap-3">
          ...
          <div className="flex flex-col items-center justify-center py-12">
            ...
            <h3 className="text-moni-white font-semibold text-lg mb-2">Retrait réussi</h3>
            <p className="text-moni-gray text-xs text-center mb-4">
              ${amount} retiré de votre compte
            </p>
            <button
              onClick={handleClose}
